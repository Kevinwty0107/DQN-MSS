# -*- coding: utf-8 -*-
"""
Created on Tue Apr 14 15:53:02 2020
...
class Q_Fun(nn.Module):
    ...
    def forward(self, graph):
        ...
        #print(mu.dtype,x.dtype,edge_w.dtype,edge_index.dtype)
        for i in range(self.T):
            #mu = self.S2Vs[i](mu, x, edge_index, edge_w)
            mu = self.S2Vs[i].forward(mu, x, edge_index, edge_w)
        ...
        Cat = torch.cat((self.lin6(graph_pool), nodes_vec), dim=1)
